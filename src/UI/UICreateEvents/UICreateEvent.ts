...
import { handlerPushNewEvent, recordErrorMessage} from "../../Redux/Actions/EventsActionCreater";
import { Dispatch } from "redux";
import { GetAllEvents } from "../../Redux/Actions/AsyncActions";

// export function handlerSaveEvent (gState:IGlobalState, events:IEvent[], dispatch: Dispatch):void{
//     if(gState.events.createEvent.text.trim()===''){ //Если пользователь не ввел текст
